...
public class Main {
	...
	public static void main(String[] args) {
		...
		F.calcularSalarioEBeneficioPago(F.getListaFuncionario(),03, 2022);
		System.out.print("\n----");
		
		//Um método que receba uma lista de funcionários, mês e ano e retorne o total pago somente em salários no mês.
		System.out.print("\n");	
		F.calcularSalario(F.getListaFuncionario(),03, 2022);
		System.out.print("\n----");	
		...
		System.out.print("\n");	
		F.calcularBeneficioPago(F.getListaFuncionario(),03, 2022);
		System.out.print("\n----");
		
		//Um método que receba uma lista de funcionários, mês e ano e retorne o que recebeu o valor mais alto no mês.
		F.calcularMaiorSalarioEFuncionario(F.getListaFuncionario(),03, 2022);
		System.out.print("\n----");
		...
		F.calcularMaiorBeneficioEFuncionario(F.getListaFuncionario(),03, 2022);
		System.out.print("\n----");
		
		//Um método que receba uma lista de vendedores, mês e ano e retorne o que mais vendeu no mês.
		F.calcularMaiorVendaVendedor(V.getListaVenda(), 03, 2022);
		System.out.print("\n----");
	}
